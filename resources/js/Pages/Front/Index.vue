...
<template>
    <Head title="Welcome" />
    <nav class="bg-white">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between m x-auto p-4">
            <a href="/" class="flex items-center">
                <img src="../../Components/images/logo.png" class="h-20 mr-3" alt=" Logo" />
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-dark">Linna Rohmatun</span>
            </a>
        ...
        <div class="py-1 px-4 mx-auto max-w-screen-xl  lg:py-16 grid lg:grid-cols-2 gap-12 lg:gap-16">
            <div class="flex flex-col justify-center">
                ...
                <div class="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
                  <a href="#" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-[#A076F9] hover:bg-[#6528F7] focus:ring-4 focus:ring-blue-300">
              Get started
            ...
            <div>
                <LottieAnimation :animation-data="WatermelonJSON" :auto-play="true" :height="50" :loop="true" :speed="1"
                    ref="anim" />
            </div>
        </div>
    </section>
            ...
            <div class="w-full text-center sm:w-3/4 lg:w-3/5 lg:text-left">
                ...
                <div class="flex flex-col justify-center pt-6 sm:flex-row lg:justify-start">
                    <div class="flex items-center justify-center sm:justify-start">
                        <a href="https://instagram.com/linnnaar?igshid=OGQ5ZDc2ODk2ZA=="
                            class="font-body text-lg font-semibold uppercase text-grey-20"> Instagram </a>
            ...
            <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
                <div className="sm:col-span-12 lg:col-span-3">
                    ...
                    <div className="text-sm text-gray-600">
                        <img src="../../Components/images/logo.png" class="h-35 mr-10" alt=" Logo" />
                    </div>
                </div>
